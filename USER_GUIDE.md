...
├── planning.md        # Initial plan
├── tasks.md          # Task tracking
├── execution.md      # Execution log
├── conversation.json # Improvement history
└── logs/             # Detailed logs
```
...
### DO:
1. ✅ Use `--interactive` for initial creation (review plan first)
2. ✅ Navigate to project directory before using `improve`
3. ✅ Make small, incremental improvements
4. ✅ Check git log to track changes
5. ✅ Test after each improvement

### DON'T:
1. ❌ Don't modify `.agent_context/` files manually
2. ❌ Don't make too many changes in one improve command
3. ❌ Don't delete git history (you'll lose undo capability)
